...
public class OrderManageAction {
	...
	//添加评论初始化界面
	@RequestMapping("/orderpladdHistory")
	public String orderpladdHistory(Map<String, Object> map,String order_car_id,Model model){
		model.addAttribute("carId", order_car_id);
		//获取前台传过来的值
		System.out.println(order_car_id);
		return "user/order/pinglun_add";
	}
}
