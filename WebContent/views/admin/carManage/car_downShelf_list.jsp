	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/queryDownShelfCarById">
...
<%--							<td><img src="${car.getCar_img() }" width="210px"></td>--%>
							...
							<td style="vertical-align:middle">
<%--								<a href="${pageContext.request.contextPath }/admin/carUpdateDownShelf?car_id=${car.getCar_id()}"><button class="btn btn-primary">修改</button></a>--%>
								<a href="${pageContext.request.contextPath }/admin/carUpShelfById?car_id=${car.getCar_id()}"><button class="btn btn-info">上架</button></a>
								<a href="${pageContext.request.contextPath }/admin/carDelete?car_id=${car.getCar_id()}"><button class="btn btn-danger">删除</button></a>
							</td>
						</tr>
						</c:forEach>
				...
				<center>
					<c:if test="${requestScope.queryKind == 'all' }">
						<ul class="pagination pagination-lg">
							<li><a href="${pageContext.request.contextPath }/admin/queryAllDownShelfCar?currentpage=1">首页</a></li>
							<li><a href="${pageContext.request.contextPath }/admin/queryAllDownShelfCar?currentpage=${requestScope.page.getFront()}">&laquo;上一页</a></li>
						    <li><a>${requestScope.page.getCurrentpage() }</a></li>
						    <li><a href="${pageContext.request.contextPath }/admin/queryAllDownShelfCar?currentpage=${requestScope.page.getNext()}">下一页 &raquo;</a></li>
						    <li><a href="${pageContext.request.contextPath }/admin/queryAllDownShelfCar?currentpage=${requestScope.page.getLast()}">尾页</a></li>
						</ul><br>
					</c:if>
					
					<c:if test="${requestScope.queryKind == 'idOrName' }">
						<ul class="pagination pagination-lg">
							<li><a href="${pageContext.request.contextPath }/admin/queryDownShelfCarById?currentpage=1&car_id=${ requestScope.queryString }">首页</a></li>
							<li><a href="${pageContext.request.contextPath }/admin/queryDownShelfCarById?currentpage=${requestScope.page.getFront()}&car_id=${ requestScope.queryString }">&laquo;上一页</a></li>
						    <li><a>${requestScope.page.getCurrentpage() }</a></li>
						    <li><a href="${pageContext.request.contextPath }/admin/queryDownShelfCarById?currentpage=${requestScope.page.getNext()}&car_id=${ requestScope.queryString }">下一页 &raquo;</a></li>
						    <li><a href="${pageContext.request.contextPath }/admin/queryDownShelfCarById?currentpage=${requestScope.page.getLast()}&car_id=${ requestScope.queryString }">尾页</a></li>
						</ul><br>
					</c:if>
				</center>
				<div style="height:50px"></div>
