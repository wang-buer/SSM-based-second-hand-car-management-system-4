...
<html>
	...
	<body>
		...
		<div style="min-height:600px;auto;">
			...
			<a href="${pageContext.request.contextPath }/orderManage/notSendOrder"><button type="button" style="float:right" class="btn btn-warning">未发货订单</button></a>
			...
			<a href="${pageContext.request.contextPath }/orderManage/notPayOrder"><button type="button" style="float:right" class="btn btn-info">未付款订单</button></a>
			
			
			<label style="margin-left:100px"><font size="4px">历史订单页面</font></label>
			...
			<table class="table table-condensed table-hover" style="width:90%;" align="center">
					...
					<tbody>
						...
						<tr>
							...
							<td><c:out value="${order.getOrder_car_id() }"></c:out></td>
							...
							<td>
								...
								<a href="${pageContext.request.contextPath }/orderManage/orderpladdHistory?order_car_id=${order.getOrder_car_id()}"><button class="btn btn-danger"> 评论 </button></a>
								<a href="${pageContext.request.contextPath }/orderManage/orderDeleteHistory?order_id=${order.getOrder_id()}"><button class="btn btn-warning"> 删 除  </button></a>
							</td>
						</tr>
						</c:forEach>
				...
				<br><br>
				<label style="margin-left:100px"><font size="4px">共  ${requestScope.historyOrder.size() } 条数据</font></label>
