...
<body>
	...
	<div class="rightcon" style="">
		...
		<form class="form-horizontal" role="form" id="addBrandForm"
			action="${pageContext.request.contextPath}/user/addpinglun">
			<input type="hidden" name="order_car_id" value="${carId } "
										id="carId" />
				<div style="height: 100px"></div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><font size="4px">添加评论</font></label>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><font size="4px">评论内容</font></label>
					...
					<div class="col-sm-8">
						...
						<input type="submit" class="col-sm-1 "></input>
					</div>
					<div class="col-sm-4">
						<input type="reset" value="取消" class="col-sm-2 "></input>
					</div>
				</div>
		</form>
	</div>
