...
<html>
	...
	<body>
		...
		<div style="min-height:800px;">
			...
			<label style="margin-left:80px"><font size="4px">下架车辆信息修改</font></label>
			...
			<form class="form-horizontal" role="form" id="carUpdateDownShelfForm" action="${pageContext.request.contextPath }/shop/saveDownShelfCar" enctype="multipart/form-data" method="post">

				<div class="form-group">
					<div class="col-sm-2"></div>
					<div class="col-sm-3">
						<img src="${requestScope.carUpdateDownShelf.getCar_img() }" width="300px">
				...
				<br>
				<button type="submit" style="margin-left: 250px;" class="btn btn-primary"> 提 交 </button>
				<button type="reset" style="margin-left: 50px;" class="btn btn-primary"> 取 消 </button>
				<br>
