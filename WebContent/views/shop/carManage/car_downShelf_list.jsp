...
<html>
	...
	<body>
		...
		<div style="min-height:800px;">
				...
				<label style="margin-left:80px"><font size="4px">下架汽车列表</font></label>
			...
			<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/shop/queryDownShelfCarById">
...
<%--						<th>图片</th>--%>
				...
				<tbody>
					<c:forEach items="${requestScope.carDownShelfList }" var="car">
					<tr>
<%--						<td><img src="${car.getCar_img() }" width="210px"></td>--%>
						...
						<td style="vertical-align:middle"><c:out value="${car.getCar_time_delete() }"></c:out></td>
						<td style="vertical-align:middle">
							<c:if test="${car.getCar_status_recommend()  == '0'}">否</c:if>
							<c:if test="${car.getCar_status_recommend()  == '1'}">是</c:if>
						</td>
						<td style="vertical-align:middle">
<%--							<a href="${pageContext.request.contextPath }/shop/carUpdateDownShelf?car_id=${car.getCar_id()}"><button class="btn btn-primary">修改</button></a>--%>
							<a href="${pageContext.request.contextPath }/shop/carUpShelfById?car_id=${car.getCar_id()}"><button class="btn btn-info">上架</button></a>
							<a href="${pageContext.request.contextPath }/shop/carDelete?car_id=${car.getCar_id()}"><button class="btn btn-danger">删除</button></a>
						</td>
					</tr>
					</c:forEach>
			...
			<center>
				<c:if test="${requestScope.queryKind == 'all' }">
					<ul class="pagination pagination-lg">
						<li><a href="${pageContext.request.contextPath }/shop/queryAllDownShelfCar?currentpage=1">首页</a></li>
						<li><a href="${pageContext.request.contextPath }/shop/queryAllDownShelfCar?currentpage=${requestScope.page.getFront()}">&laquo;上一页</a></li>
					    <li><a>${requestScope.page.getCurrentpage() }</a></li>
					    <li><a href="${pageContext.request.contextPath }/shop/queryAllDownShelfCar?currentpage=${requestScope.page.getNext()}">下一页 &raquo;</a></li>
					    <li><a href="${pageContext.request.contextPath }/shop/queryAllDownShelfCar?currentpage=${requestScope.page.getLast()}">尾页</a></li>
					</ul><br>
				</c:if>
				
				<c:if test="${requestScope.queryKind == 'idOrName' }">
					<ul class="pagination pagination-lg">
						<li><a href="${pageContext.request.contextPath }/shop/queryDownShelfCarById?currentpage=1&shop_id=${ sessionScope.shoploginSession.getLogin_id() }&car_id=${ requestScope.queryString }">首页</a></li>
						<li><a href="${pageContext.request.contextPath }/shop/queryDownShelfCarById?currentpage=${requestScope.page.getFront()}&shop_id=${ sessionScope.shoploginSession.getLogin_id() }&car_id=${ requestScope.queryString }">&laquo;上一页</a></li>
					    <li><a>${requestScope.page.getCurrentpage() }</a></li>
					    <li><a href="${pageContext.request.contextPath }/shop/queryDownShelfCarById?currentpage=${requestScope.page.getNext()}&shop_id=${ sessionScope.shoploginSession.getLogin_id() }&car_id=${ requestScope.queryString }">下一页 &raquo;</a></li>
					    <li><a href="${pageContext.request.contextPath }/shop/queryDownShelfCarById?currentpage=${requestScope.page.getLast()}&shop_id=${ sessionScope.shoploginSession.getLogin_id() }&car_id=${ requestScope.queryString }">尾页</a></li>
					</ul><br>
				</c:if>
			</center>	
