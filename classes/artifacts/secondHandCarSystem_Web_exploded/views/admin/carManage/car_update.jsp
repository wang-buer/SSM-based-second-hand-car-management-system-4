	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon" style="">
				...
				<form class="form-horizontal" role="form" id="carUpdateForm" action="${pageContext.request.contextPath }/admin/saveCar"  enctype="multipart/form-data" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<img src="/upload/${requestScope.carUpdate.getCar_img() }" width="300px">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select name="car_status_recommend" class="form-control">
								<c:if test="${requestScope.carUpdate.getCar_status_recommend() == '0'}">
									<option value="0">不推荐</option>
									<option value="1">推荐</option>
								</c:if>
								<c:if test="${requestScope.carUpdate.getCar_status_recommend() == '1'}">
									<option value="1">推荐</option>
									<option value="0">不推荐</option>
								</c:if>
